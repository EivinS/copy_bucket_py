...
def hello_pubsub(event, context):
     ...
     origin = storage_client.bucket('bucket-source-common')
     # Define the destination bucket
     destination = storage_client.bucket('bucket-sink-common')
     # Get the list of the blobs located inside the bucket which files you want to copy
     blobs = storage_client.list_blobs('bucket-source-common')
